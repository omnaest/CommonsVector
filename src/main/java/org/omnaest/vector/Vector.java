...
public class Vector
{
    ...
    public Vector setCoordinate(int index, double value)
    {
        double[] coordinatesNew = Arrays.copyOf(this.coordinates, this.coordinates.length);
        coordinatesNew[index] = value;
        return Vector.of(coordinatesNew);
    }
