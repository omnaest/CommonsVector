...
public class VectorTest
{
    ...
    {
        assertEquals(100, new Vector(0, 100).closestDistanceToLine(new Vector(0, 0), new Vector(1, 0)), 0.001);
        assertEquals(0, new Vector(0, 100).closestDistanceToLine(new Vector(0, 0), new Vector(0, 10)), 0.001);
        assertEquals(0, new Vector(100, 0).closestDistanceToLine(new Vector(0, 0), new Vector(1, 0)), 0.001);
    }
